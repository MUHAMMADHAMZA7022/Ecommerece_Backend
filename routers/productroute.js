...
router.route("/admin/newproduct").post(authenticate, authorizerole("admin"), newproduct) //yha url chnge krty rho create ka banana ya jes ka b bnana
...
router.route("/admin/product/:id").put(authenticate, authorizerole("admin"), updateproduct) //yha url chnge krty rho update ka banana ya jes ka b bnana
router.route("/admin/product/:id").delete(authenticate, authorizerole("admin"), deleteproduct) //yha url chnge krty rho delete ka banana ya jes ka b bnana
