...
exports.updateorder = catchasyncerror(async (req, res, next) => {
    ...
    if (order.orderStatus === "Delivered") {//ye delivered k liye lgya agr already ha
        return next(new Errorhandler("You have already delivered this order", 400));

    }
    order.orderItems.forEach(async (order) => {//ye stock minus kiya ha function bnya nechy
...
async function updateStock(id, quantity) {//ye update ka bntya ha function stcok wala 
